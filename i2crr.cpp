/**
 * I2C Pin Rerouting for micro:bit
 *
 * Original Author: Bill Siever
 * Original Repository: https://github.com/bsiever/microbit-pxt-i2cpins
 * Date: 2021-10-02
 * License: MIT
 *
 * This code allows reassigning the I2C pins to non-default locations.
 * Integrated into Rakettsensorer extension with permission under MIT license.
 *
 * IMPORTANT WARNING for micro:bit v1:
 * Micro:bit v1 only has one I2C port. Changing the pins will prevent
 * the accelerometer/compass from working!!!
 *
